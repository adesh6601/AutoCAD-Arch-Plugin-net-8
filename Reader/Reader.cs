...
public class Reader
{
	...
	private void ReadEntitiesForProject(ProjectFile projectFile, Entities entities)
	{
		...
		foreach (Autodesk.AutoCAD.DatabaseServices.ObjectId objectId in BlockTableRecord)
		{
			...
			object convertedEntity = EntityConvertor.ConvertEntity(entity, entityType, UnitConversionFactor);
	...
	private void AddEntityToEntites(string entityType, object convertedEntity, Entities entities)
	{
		...
		if (entityType == "windowAssemblyAsWall")
		{
			...
			EntityConvertor.ConvertWindowAssemblyAsWallToWall(convertedEntity, wall);
